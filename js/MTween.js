    ...
    else
    {
        ...
        for(var s in element.transform)
        {
            switch(s)
            {
                ...
                case 'scaleX':
                case 'scaleZ':
                    csstransform+=' '+s+'('+(element.transform[s])+')';
                    break;
                case 'rotate':
                case 'rotateX':
                case 'rotateY':
                ...
                case 'skewY':
                case 'skewX':
                    csstransform+=' '+s+'('+element.transform[s]+'deg)';
                    break;
                default:
                    csstransform+=' '+s+'('+element.transform[s]+'px)';
            }
        }
        element.style.WebkitTransform=element.style.transform=csstransform;
    }
}
...
function css(element,attr,val)
{
    ...
    else
    {
        ...
        {
            var value=window.getComputedStyle(element)[attr];
            if(attr=='opacity')
            {
...
function mTween(init)
{
    ...
    init.el.timer=setInterval(function(){
        ...
        {
            clearInterval(init.el.timer);
            init.callBack&&init.callBack(init.el);
        }
        else
        {
